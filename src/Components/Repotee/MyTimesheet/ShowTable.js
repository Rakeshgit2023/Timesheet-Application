        ...
        <div className="flex justify-center items-start mb-3">
                ...
                <div className="flex flex-col w-7/12 mt-2 ml-1 lg:ml-8 mr-1 lg:mr-5">
                    <div className="flex justify-between gap-2 lg:gap-8 w-full ">
                            <input  className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-base lg:text-lg" value={weeklyHours.sun} onChange={handelSun}></input>
                            <input  className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-base lg:text-lg" value={weeklyHours.mon} onChange={handelMon}></input>
                            <input  className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-base lg:text-lg" value={weeklyHours.tue} onChange={handelTue}></input>
                            <input  className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-base lg:text-lg" value={weeklyHours.wed} onChange={handelWed}></input>
                            <input  className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-base lg:text-lg" value={weeklyHours.thurs} onChange={handelThu}></input>
                            <input  className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-base lg:text-lg" value={weeklyHours.fri} onChange={handelFri}></input>
                            <input  className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-base lg:text-lg" value={weeklyHours.sat} onChange={handelSat}></input>
                    </div>
                    <div className="flex gap-2 lg:gap-8 mt-2">
                            <input placeholder="Note Here" className="w-1/4 py-2 lg:py-4 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.sun} onChange={handelSunNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.mon} onChange={handelMonNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.tue} onChange={handelTueNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.wed} onChange={handelWedNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.thurs} onChange={handelThuNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.fri} onChange={handelFriNotes}></input>
                            <input placeholder="Note Here" className="w-1/4 py-1 lg:py-2 border-solid border-2 border-gray-400 text-center rounded-md text-xs" value={weeklyNotes.sat} onChange={handelSatNotes}></input>
                    </div>
                </div>
