...
const TeamDashbord = () => {
    ...
    const handleDataFetchTeamDashbordData = (empId) => {
        ...
        axiosInstance
            ...
            .then((res) => {
                ...
                setDirectRepotees(res.data.data[0].directReportees);
                setAssociatedClients(res.data.data[0].clients);
    ...
    return (
        <div className="flex flex-col ml-6 lg:ml-8 mr-2 lg:mr-5 mt-2 lg:mt-5 mb-2 lg:mb-5 overflow-auto scrollbar-hide" style={{ height: '700px' }}>
            ...
            <div className="mt-1">
                <span className="text-sm lg:text-xl font-base text-slate-500">Reporting Lead</span>
            </div>
            ...
            <div className="flex flex-col lg:flex-row lg:gap-6 w-full">
                <div className="w-full lg:w-1/3 h-40 lg:h-80 rounded-md bg-white mt-2 lg:mt-4 shadow-2xl overflow-x-auto">
                    <h3 className="font-bold text-base lg:text-xl text-slate-800 mb-1 mt-1 px-6">Direct Repotees</h3>
